    ...
    >
      ...
      <div className="home-container -mt-[160px] pt-0 pb-20 md:mt-0 md:py-24">
        ...
        <div className="relative min-h-[520px] lg:min-h-[720px]">
          ...
          <RewardsStage hovered={cardHover} className="relative z-10 mx-auto mt-[320px] w-full max-w-[1060px] origin-top scale-[1.8] lg:mx-0 lg:mt-0 lg:max-w-[58%] lg:origin-[40%_top] lg:translate-y-[60px] lg:scale-[1.325]" />
