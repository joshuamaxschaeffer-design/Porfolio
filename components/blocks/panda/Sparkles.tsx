...
const SPARKS: Spark[] = [
  ...
  { id: 8, kind: 'sparkle', x: 88.0, y: 6.0, size: 30, delay: 0.8, period: 8.0 },
  { id: 9, kind: 'star', x: 90.5, y: 25, size: 18, delay: 5.9, period: 9.1 },
  { id: 10, kind: 'firework', x: 93.5, y: 9.5, size: 38, delay: 2.2, period: 8.4 },
  { id: 11, kind: 'star', x: 3.0, y: 21, size: 18, delay: 4.8, period: 9.3 },
  ...
  { id: 14, kind: 'star', x: 4.5, y: 28, size: 16, delay: 6.1, period: 8.7 },
